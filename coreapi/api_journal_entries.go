...
type ApiGetAccountJournalEntryRequest struct {
	ctx context.Context
...
func (r ApiGetAccountJournalEntryRequest) Execute() (*JournalEntry, *http.Response, error) {
...
Retrieve a journal entry for a credit account.
 ...
 @param accountToken The unique identifier of the credit account for which you want to retrieve journal entries.  Send a `GET` request to `/credit/accounts` to retrieve existing credit account tokens.
 @param journalEntryToken The unique identifier of the journal entry you want to retrieve.  Send a `GET` request to `/credit/accounts/{account_token}/journalentries` to retrieve existing journal entry tokens.
 @return ApiGetAccountJournalEntryRequest
*/
func (a *JournalEntriesAPIService) GetAccountJournalEntry(ctx context.Context, accountToken string, journalEntryToken string) ApiGetAccountJournalEntryRequest {
	return ApiGetAccountJournalEntryRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return JournalEntry
func (a *JournalEntriesAPIService) GetAccountJournalEntryExecute(r ApiGetAccountJournalEntryRequest) (*JournalEntry, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/credit/accounts/{account_token}/journalentries/{journal_entry_token}"
...
type ApiListAccountJournalEntriesRequest struct {
	ctx context.Context
	ApiService *JournalEntriesAPIService
	accountToken string
	count *int32
...
func (r ApiListAccountJournalEntriesRequest) Count(count int32) ApiListAccountJournalEntriesRequest {
	r.count = &count
	return r
}

// Sort order index of the first resource in the returned array.
func (r ApiListAccountJournalEntriesRequest) StartIndex(startIndex int32) ApiListAccountJournalEntriesRequest {
	r.startIndex = &startIndex
	return r
}

// The starting date of the date range from which to return journal entries.
func (r ApiListAccountJournalEntriesRequest) StartDate(startDate string) ApiListAccountJournalEntriesRequest {
	r.startDate = &startDate
	return r
}

// The ending date of the date range from which to return journal entries.
func (r ApiListAccountJournalEntriesRequest) EndDate(endDate string) ApiListAccountJournalEntriesRequest {
	r.endDate = &endDate
	return r
}

// The starting impact_time of the date range from which to return journal entries.
func (r ApiListAccountJournalEntriesRequest) StartImpactTime(startImpactTime string) ApiListAccountJournalEntriesRequest {
	r.startImpactTime = &startImpactTime
	return r
}

// The ending impact_time of the date range from which to return journal entries.
func (r ApiListAccountJournalEntriesRequest) EndImpactTime(endImpactTime string) ApiListAccountJournalEntriesRequest {
	r.endImpactTime = &endImpactTime
	return r
}

// The starting created_date of the date range from which to return journal entries.
func (r ApiListAccountJournalEntriesRequest) StartCreatedTime(startCreatedTime string) ApiListAccountJournalEntriesRequest {
	r.startCreatedTime = &startCreatedTime
	return r
}

// The ending created_date of the date range from which to return journal entries.
func (r ApiListAccountJournalEntriesRequest) EndCreatedTime(endCreatedTime string) ApiListAccountJournalEntriesRequest {
	r.endCreatedTime = &endCreatedTime
	return r
}

// An array of statuses by which to filter journal entries.
func (r ApiListAccountJournalEntriesRequest) Statuses(statuses []string) ApiListAccountJournalEntriesRequest {
	r.statuses = &statuses
	return r
}

// An array of groups by which to filter journal entries.  To return all journal entry groups, do not include this query parameter.
func (r ApiListAccountJournalEntriesRequest) Groups(groups []string) ApiListAccountJournalEntriesRequest {
	r.groups = &groups
	return r
}

// Embeds the specified object into the response.
func (r ApiListAccountJournalEntriesRequest) Expand(expand string) ApiListAccountJournalEntriesRequest {
	r.expand = &expand
	return r
}
...
func (r ApiListAccountJournalEntriesRequest) SortBy(sortBy string) ApiListAccountJournalEntriesRequest {
	r.sortBy = &sortBy
	return r
}

// An array of card tokens by which to filter journal entries. Returns journal entries associated with the specified card tokens.  Send a &#x60;GET&#x60; request to &#x60;/credit/accounts/{account_token}/cards/&#x60; to retrieve existing card tokens.
func (r ApiListAccountJournalEntriesRequest) CardTokens(cardTokens []string) ApiListAccountJournalEntriesRequest {
	r.cardTokens = &cardTokens
	return r
}

// An array of user tokens by which to filter journal entries. Returns journal entries associated with the specified user tokens.  Send a &#x60;GET&#x60; request to &#x60;/users&#x60; to retrieve existing user tokens.
func (r ApiListAccountJournalEntriesRequest) UserTokens(userTokens []string) ApiListAccountJournalEntriesRequest {
	r.userTokens = &userTokens
	return r
}

// An array of &lt;&lt;/core-api/event-types#_credit_journal_entry_events, event types&gt;&gt; by which to filter journal entries.  To return all event types, do not include this query parameter.
func (r ApiListAccountJournalEntriesRequest) Types(types []string) ApiListAccountJournalEntriesRequest {
	r.types = &types
	return r
}

func (r ApiListAccountJournalEntriesRequest) Execute() (*JournalEntriesPage, *http.Response, error) {
...
This endpoint supports <</core-api/sorting-and-pagination, sorting and pagination>> and <</core-api/object-expansion, object expansion>>.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param accountToken The unique identifier of the credit account for which you want to retrieve journal entries.  Send a `GET` request to `/credit/accounts` to retrieve existing credit account tokens.
 @return ApiListAccountJournalEntriesRequest
*/
func (a *JournalEntriesAPIService) ListAccountJournalEntries(ctx context.Context, accountToken string) ApiListAccountJournalEntriesRequest {
	return ApiListAccountJournalEntriesRequest{
		ApiService: a,
		ctx: ctx,
		accountToken: accountToken,
...
func (a *JournalEntriesAPIService) ListAccountJournalEntriesExecute(r ApiListAccountJournalEntriesRequest) (*JournalEntriesPage, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath := localBasePath + "/credit/accounts/{account_token}/journalentries"
	localVarPath = strings.Replace(localVarPath, "{"+"account_token"+"}", url.PathEscape(parameterValueToString(r.accountToken, "accountToken")), -1)
...
*/
func (a *JournalEntriesAPIService) ResendWebhookEvent(ctx context.Context, eventType string, resourceToken string) ApiResendWebhookEventRequest {
	return ApiResendWebhookEventRequest{
		ApiService: a,
		ctx: ctx,
		eventType: eventType,
...
func (a *JournalEntriesAPIService) ResendWebhookEventExecute(r ApiResendWebhookEventRequest) (*WebhookEventResendContainerResponse, *http.Response, error) {
	var (
