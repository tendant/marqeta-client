...
*/
func (a *RedemptionsAPIService) RetrieveRedemptionsBySettlementDate(ctx context.Context) ApiRetrieveRedemptionsBySettlementDateRequest {
	return ApiRetrieveRedemptionsBySettlementDateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *RedemptionsAPIService) RetrieveRedemptionsBySettlementDateExecute(r ApiRetrieveRedemptionsBySettlementDateRequest) (*RedemptionsBySettlementDatePage, *http.Response, error) {
	var (
