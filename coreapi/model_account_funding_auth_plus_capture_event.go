...
// checks if the AccountFundingAuthPlusCaptureEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountFundingAuthPlusCaptureEvent{}
...
func (o AccountFundingAuthPlusCaptureEvent) ToMap() (map[string]interface{}, error) {
