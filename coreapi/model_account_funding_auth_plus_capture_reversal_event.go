...
// checks if the AccountFundingAuthPlusCaptureReversalEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountFundingAuthPlusCaptureReversalEvent{}
...
func (o AccountFundingAuthPlusCaptureReversalEvent) ToMap() (map[string]interface{}, error) {
