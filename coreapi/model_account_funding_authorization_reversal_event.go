...
// checks if the AccountFundingAuthorizationReversalEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountFundingAuthorizationReversalEvent{}
...
func (o AccountFundingAuthorizationReversalEvent) ToMap() (map[string]interface{}, error) {
