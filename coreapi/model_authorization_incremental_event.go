...
// checks if the AuthorizationIncrementalEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthorizationIncrementalEvent{}
...
func (o AuthorizationIncrementalEvent) ToMap() (map[string]interface{}, error) {
