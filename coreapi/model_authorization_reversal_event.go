...
// checks if the AuthorizationReversalEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthorizationReversalEvent{}
...
func (o AuthorizationReversalEvent) ToMap() (map[string]interface{}, error) {
