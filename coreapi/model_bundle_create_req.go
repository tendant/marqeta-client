...
type BundleCreateReq struct {
	...
	AprPolicyToken string `json:"apr_policy_token"`
	// Unique identifier of the credit product policy.
	CreditProductPolicyToken string `json:"credit_product_policy_token"`
	// Description of the bundle.
	Description string `json:"description"`
	// Unique identifier of the document policy.
	DocumentPolicyToken string `json:"document_policy_token"`
	// Unique identifier of the fee policy.
	FeePolicyToken string `json:"fee_policy_token"`
	// Name of the bundle.
