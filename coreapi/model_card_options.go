...
// CardOptions Contains attributes that govern card usage
type CardOptions struct {
	...
	BillingAddress *CardOptionsBillingAddress `json:"billing_address,omitempty"`
}
...
func (o *CardOptions) GetBillingAddress() CardOptionsBillingAddress {
	if o == nil || IsNil(o.BillingAddress) {
		var ret CardOptionsBillingAddress
		return ret
	}
...
// SetBillingAddress gets a reference to the given CardOptionsBillingAddress and assigns it to the BillingAddress field.
