...
// checks if the CardTransactionResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardTransactionResponse{}
...
func (o CardTransactionResponse) ToMap() (map[string]interface{}, error) {
