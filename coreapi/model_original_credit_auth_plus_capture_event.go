...
// checks if the OriginalCreditAuthPlusCaptureEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OriginalCreditAuthPlusCaptureEvent{}
...
func (o OriginalCreditAuthPlusCaptureEvent) ToMap() (map[string]interface{}, error) {
