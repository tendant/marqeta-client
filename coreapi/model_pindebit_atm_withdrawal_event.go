...
// checks if the PindebitAtmWithdrawalEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PindebitAtmWithdrawalEvent{}
...
func (o PindebitAtmWithdrawalEvent) ToMap() (map[string]interface{}, error) {
