...
// checks if the PindebitAuthorizationReversalEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PindebitAuthorizationReversalEvent{}
...
func (o PindebitAuthorizationReversalEvent) ToMap() (map[string]interface{}, error) {
