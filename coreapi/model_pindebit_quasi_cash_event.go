...
// checks if the PindebitQuasiCashEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PindebitQuasiCashEvent{}
...
func (o PindebitQuasiCashEvent) ToMap() (map[string]interface{}, error) {
