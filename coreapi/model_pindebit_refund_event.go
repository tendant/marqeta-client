...
// checks if the PindebitRefundEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PindebitRefundEvent{}
...
func (o PindebitRefundEvent) ToMap() (map[string]interface{}, error) {
