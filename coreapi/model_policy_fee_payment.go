...
type PolicyFeePayment struct {
	DefaultMethod *FeeMethod `json:"default_method,omitempty"`
	// Amount of the fee.
...
// SetDefaultMethod gets a reference to the given FeeMethod and assigns it to the DefaultMethod field.
