...
// checks if the RefundAuthorizationReversalEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RefundAuthorizationReversalEvent{}
...
func (o RefundAuthorizationReversalEvent) ToMap() (map[string]interface{}, error) {
