...
// checks if the RefundEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RefundEvent{}
...
func (o RefundEvent) ToMap() (map[string]interface{}, error) {
